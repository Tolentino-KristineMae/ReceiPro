    ...
    <div className="fs-root">
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
          ...
          <div style={{
            ...
            <span style={{ color: 'rgba(67,20,7,0.6)', fontSize: '11px', fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      {ocrResults && ocrResults.length > 0 && (
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px', flexWrap: 'wrap' }}>
          <div style={{
            ...
            <span style={{ color: '#10b981', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: "'Space Grotesk', sans-serif" }}>
              ✓ Verified
            </span>
            <span style={{
              background: 'rgba(16,185,129,0.15)', color: '#059669',
              borderRadius: '8px', padding: '4px 10px', fontSize: '13px', fontWeight: 900,
              fontFamily: "'Space Mono', monospace", minWidth: '32px', textAlign: 'center'
            }}>{verifiedCount}</span>
          </div>
          ...
          {notFoundCount > 0 && (
            <div style={{
              ...
              <span style={{ color: '#dc2626', fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: "'Space Grotesk', sans-serif" }}>
                ✕ Missing
              </span>
              <span style={{
      ...
      {finalizedBatch && (
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '9px', fontWeight: 800, color: 'rgba(67,20,7,0.45)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '4px', fontFamily: "'Space Grotesk', sans-serif" }}>
              Batch Number
            </div>
            <div style={{ fontSize: '14px', fontWeight: 900, color: '#431407', fontFamily: "'Space Mono', monospace" }}>
          ...
          <div style={{ padding: '8px 16px', borderRadius: '8px', background: 'rgba(249,115,22,0.08)', border: '1px solid rgba(249,115,22,0.2)' }}>
            <span style={{ color: '#f97316', fontSize: '11px', fontWeight: 800, fontFamily: "'Space Grotesk', sans-serif" }}>
              Transactions Linked
            </span>
          </div>
        </div>
